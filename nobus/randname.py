...
left = [
    ...
    "blissful",
    "bold",
    # "boring", # eliminated in order to avoid "boring-wozniak" logic
    "bouncy", # added instead of "boring"
    "brave",
    "busy",
    "charming",
    "clever",
...
def get_random_name(retry: int=0) -> str:
    ...
    # # funny but stupid original logic.
    # # we avoided this infinite loop by removing "boring" from the list of adjective candidates.
    # # Note that "boring" has been removed from the list of adjective candidates, and "bouncy" has been added instead.
    # while True:
...
def generate_random_name(seed=None) -> str:
    """
    This is a user-friendly version to suit our purposes.
    The name is formatted in the "adjective-surname" format for easy combination with the ISO 8601 date-time format.
    """
